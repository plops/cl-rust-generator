...
use proto_def::graphical_proxy::{
    ...
    ClientEvent, ServerUpdate,
};

mod browser;
use browser::{extract_spatial_metadata, CdpStream, ChromeRunner};
...
enum Commands {
    ...
    #[command(after_help = "ENCODING STRATEGIES:
...
async fn test_chrome_extraction(
    url: &str,
    ...
    println!(
        "Document Size: {}x{}",
        metadata.document_width, metadata.document_height
    );
