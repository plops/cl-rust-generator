...
use proto_def::graphical_proxy::{remote_browser_client::RemoteBrowserClient, ClientEvent};
...
impl ConnectionManager {
    ...
    pub async fn create_stream(
        ...
        tonic::Streaming<proto_def::graphical_proxy::ServerUpdate>,
    ...
    > {
        ...
        let request = Request::new(tokio_stream::wrappers::ReceiverStream::new(
            rx_events_internal,
        ));
