#!/bin/bash
# fetch_assets.sh — lädt Gewichte + Vokabular (PP-OCRv6) für source6.
#
...
# per include_bytes!/include_str!). Bereits vorhandene Dateien mit korrekter
# Prüfsumme werden übersprungen.
#
# Quellen (Apache-2.0):
