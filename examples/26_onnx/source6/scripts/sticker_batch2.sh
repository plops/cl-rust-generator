...
DRY_RUN=()
SUBJECTS=(
  # # 1. Ultra-Cute Baby Animals & Pets (Top Tier)
  # "baby otter"
  # "red panda cub"
  # "lop-eared bunny"
  ...
  # 2. Chubby Birds & Tiny Wild Critters
  # "Shima Enaga (fluffy white bird)"
  # "baby penguin chick"
  # "chubby pygmy owl"
  ...
  # 3. Fantasy, Mythical & Whimsical Creatures
  # "chubby baby dragon with tiny wings"
  # "baby unicorn with a pastel mane"
  # "friendly bedsheet ghost"
  #"fluffy snow yeti cub"
#  "tiny star sprite"
#  "baby phoenix chick"
#  "miniature cloud spirit"
#  "chubby griffin cub"

  # 4. Baby Dinosaurs & Tiny Monsters
#  "chubby baby triceratops"
#  "round baby T-Rex"
  "baby brontosaurus"
  "one-eyed fuzzy little monster"
  "soft clay extraterrestrial alien"
  "miniature sea monster cub"

  # 5. Personified Objects & Nature
  "smiling crescent moon wearing a nightcap"
  "puffy little rain cloud"
  "chubby golden star"
  "tiny toadstool mushroom"
  "mug of hot cocoa with marshmallows"
  "little clay acorn"
  "miniature planet with pastel rings"

  # 6. Tiny Forest Bugs & Critters
  "fuzzy bumblebee"
  "round green tree frog"
  "baby ladybug"
  "sleepy garden snail"
  "chubby caterpillar"
)
...
run_step() { # secs toml beschreibung
  ...
  timeout --foreground "$1" "$BIN" -a --rules "$2" "${DRY_RUN[@]}" || code=$?
  if [ "$code" -eq 124 ]; then
